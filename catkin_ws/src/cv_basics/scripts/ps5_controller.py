...
class PlayStation5Controller:
    ...
    def __init__(self):
        ...
        self.left_vibration_flag = 0
        self.right_vibration_flag = 0
    ...
    def ps5_callback(self, ps5_msg):
        ...
        self.left_vibration_flag = ps5_msg.buttons[1]
        self.right_vibration_flag = ps5_msg.buttons[3]
    ...
    def publish_ps5feedback(self):
        while (self.left_vibration_flag == 1):
            print('left_vibration_flag = 1. Max intensity vibration')
        ...
        while (self.right_vibration_flag == 1):
            print('right_vibration_flag = 1. Max intensity vibration')
