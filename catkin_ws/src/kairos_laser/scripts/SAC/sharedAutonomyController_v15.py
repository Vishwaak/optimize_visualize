...
#-------------------------------------------------------------------------------------------------
#   @file       : sharedAutonomyController_v15.py
#   @author     : PARAM D SALUNKHE | UTARI - AIS
#   @comments   : Added sequential execution for utilizing front and rear LIDAR.
#                 To be later executed using multithreading
#-------------------------------------------------------------------------------------------------
...
class SharedAutonomyController:
    ...
    def __init__(self):
        ...
        self.rep_from = ALL_OBSTACLES                    # repulsion experienced from ALL_OBSTACLES / CLOSEST_OBSTACLE
